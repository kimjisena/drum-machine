...
function MidPad({pos, name, id, clickHandler}) {
    ...
    return (
        <>
            <div onClick={(ev) => handleClick(ev)} className={`pad hover:cursor-pointer absolute ${pos} flex justify-center items-center bg-black-one rounded-full w-24 h-24`}>
