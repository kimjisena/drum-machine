...
function MaxPad({pos, name, id}) {
    ...
    return (
        <>
            <div onClick={(ev) => handleClick(ev)} className={`pad hover:cursor-pointer absolute ${pos} flex justify-center items-center bg-black-one rounded-full w-28 h-28`}>
